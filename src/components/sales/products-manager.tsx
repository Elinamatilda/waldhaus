...
import { createProductAction, toggleProductActiveAction, updateProductAction } from "@/app/(authenticated)/sales/actions";
              ...
              <TableRow key={row.id}>
                <TableCell>
                  <Link
                    ...
                    href={`/sales/products/${row.id}${isSystemAdmin ? `?org=${organizationId}` : ""}`}
                  >
                    {row.name}
                  </Link>
                </TableCell>
